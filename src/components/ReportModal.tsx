...
export const ReportModal: FC<{ format: SupportFormat, dicionary?: Partial<TextDictionary>, callback: (result: string | Blob) => void }> = ({ dicionary, callback }) => {
  ...
  return (
    <div id="L-ModalPlugin-root">
      <div id="L-ModalPlugin_body">
        ...
        <textarea placeholder={dic.placeholder} />
...
const Button: FC<{ children: ComponentChildren, theme: string, onClick?: () => void }> = ({ theme, children, onClick }) => {
  return (
